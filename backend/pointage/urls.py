...
urlpatterns = [
    ...
    path("resume-paie/", resume_paie, name="pointage-resume-paie"),
    path("badge-temporaire/qr/", badge_temporaire_qr, name="pointage-badge-temporaire-qr"),
    path("badge-temporaire/regenerer/", badge_temporaire_regenerer, name="pointage-badge-temporaire-regenerer"),
    ...
    path("badge-absence/regenerer/", badge_absence_regenerer, name="pointage-badge-absence-regenerer"),
