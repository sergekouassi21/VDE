    ...
    <div style={styles.page}>
      <div style={styles.shell}>
        ...
        {ferme && !ferme.est_vide && calc && <>
          ...
          {erreur && <p style={{ color: CLAY, textAlign: "center", fontSize: 14, margin: "10px 16px 0" }}>{erreur}</p>}
          {conflitVersion && (
...
const styles = {
  ...
  dateInput: { background: "none", border: "none", color: "#fff", fontSize: 14, fontFamily: "inherit", colorScheme: "dark", cursor: "pointer" },
  ...
  chefNom: { fontSize: 14, opacity: .85, margin: 0 },
  ...
  selectSub: { opacity: .8, fontWeight: 400, fontSize: 14 },
  ...
  optionMeta: { fontSize: 14, color: TEXTE_META },
  ...
  ageUnit: { fontSize: 14, fontWeight: 400, opacity: .85 },
  ...
  fieldLabel: { fontSize: 14, color: TEXTE_SOMBRE, fontWeight: 500, marginBottom: 5, display: "flex", alignItems: "center", gap: 6 },
  ...
  alerte: { margin: "10px 16px 0", display: "flex", alignItems: "center", gap: 8, background: ALERTE_FOND, color: ALERTE, padding: "10px 13px", borderRadius: 10, fontSize: 14, fontWeight: 500 },
  ...
  checkboxRow: { display: "flex", alignItems: "center", gap: 8, fontSize: 14, color: TEXTE_SOMBRE, padding: "10px 0 4px", cursor: "pointer" },
  ...
  conflitBox: { display: "flex", flexDirection: "column", alignItems: "center", gap: 8, background: ALERTE_FOND, color: ALERTE, fontSize: 14, fontWeight: 500, padding: "12px 16px", margin: "10px 16px 0", borderRadius: 10, textAlign: "center" },
  conflitBtn: { background: ALERTE, color: "#fff", border: "none", borderRadius: 9, padding: "9px 16px", fontSize: 14, fontWeight: 600, fontFamily: "inherit", cursor: "pointer" },
  interditTxt: { textAlign: "center", fontSize: 14, color: ALERTE, margin: "18px 16px 0", fontWeight: 500 },
  ...
  videTxt: { fontSize: 14, color: TEXTE_GRIS, lineHeight: 1.5, margin: "0 0 20px" },
  ...
  sortieDetail: { flex: 1, fontSize: 14, color: INK },
  ...
  sortieAddBtn: { background: GREEN_DARK, color: "#fff", border: "none", borderRadius: 9, padding: "10px", fontSize: 14, fontWeight: 600, fontFamily: "inherit", cursor: "pointer" },
  clotureBtn: { marginTop: 10, display: "flex", alignItems: "center", justifyContent: "center", gap: 7, width: "100%", background: "rgba(255,255,255,.14)", border: "1px solid rgba(255,255,255,.3)", color: "#fff", borderRadius: 11, padding: "10px", fontSize: 14, fontWeight: 600, fontFamily: "inherit", cursor: "pointer" },
  ...
  submitBtnCloture: { background: GREEN, color: "#fff", border: "none", borderRadius: 10, padding: "11px 18px", fontSize: 14, fontWeight: 600, fontFamily: "inherit", cursor: "pointer", marginTop: 4 },
