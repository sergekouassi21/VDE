...
const styles = {
  ...
  erreurChargement: {
    ...
    fontSize: 14, fontWeight: 500, padding: "10px 16px", marginBottom: 14, borderRadius: 10, lineHeight: 1.35,
  },
  ...
  date: { fontSize: 14, color: TEXTE_META, textTransform: "capitalize" },
  ...
  kpiFermeNom: { fontSize: 14, fontWeight: 700, color: GREEN_DARK, marginBottom: 8 },
  ...
  noAlert: { fontSize: 14, color: GREEN, background: VERT_FOND, borderRadius: 10, padding: "14px", textAlign: "center", margin: 0 },
  ...
  fermeDetailValeur: { fontSize: 14, fontWeight: 600, color: GREEN_DARK },
