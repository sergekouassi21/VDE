...
const styles = {
  ...
  empty: { textAlign: "center", color: TEXTE_DOUX, fontSize: 14, margin: 0 },
  ...
  texte: { fontSize: 14, color: TEXTE_GRIS, lineHeight: 1.5, margin: 0 },
  submitBtn: { display: "flex", alignItems: "center", justifyContent: "center", gap: 7, background: GREEN, color: "#fff", border: "none", borderRadius: 10, padding: "11px 18px", fontSize: 14, fontWeight: 600, fontFamily: "inherit", cursor: "pointer", alignSelf: "flex-start" },
  dangerBtn: { display: "flex", alignItems: "center", justifyContent: "center", gap: 7, background: "#fff", color: CLAY, border: "1.5px solid #E0BBA9", borderRadius: 10, padding: "11px 18px", fontSize: 14, fontWeight: 600, fontFamily: "inherit", cursor: "pointer", alignSelf: "flex-start" },
  cancelBtn: { background: "none", border: "none", color: TEXTE_META, fontSize: 14, fontFamily: "inherit", cursor: "pointer", padding: "4px 0" },
