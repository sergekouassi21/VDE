...
const styles = {
  ...
  tab: { flex: 1, display: "flex", alignItems: "center", justifyContent: "center", gap: 6, background: "#fff", border: "1px solid #ECE9DF", color: TEXTE_META, padding: "10px 8px", borderRadius: 10, fontSize: 14, fontWeight: 500, fontFamily: "inherit", cursor: "pointer" },
  ...
  select: { flex: 1, minWidth: 140, border: "1px solid #DDE2DE", borderRadius: 8, padding: "9px 10px", fontSize: 14, fontFamily: "inherit", background: FOND_CARTE, color: INK },
  ...
  erreur: { color: ALERTE, background: "#FBF0EB", borderRadius: 10, padding: "10px 14px", fontSize: 14, marginTop: 12 },
  ...
  creanceLabel: { fontSize: 14, opacity: .9, display: "block", marginBottom: 4 },
  ...
  venduLabel: { fontSize: 14, opacity: .9, display: "block", marginBottom: 4 },
  ...
  recapRow: { display: "flex", justifyContent: "space-between", fontSize: 14, color: TEXTE_SOMBRE, padding: "6px 0" },
  ...
  soldeBtn: { background: VERT_FOND, border: `1px solid ${GREEN}`, color: GREEN_DARK, borderRadius: 8, padding: "0 14px", fontSize: 14, fontWeight: 600, fontFamily: "inherit", cursor: "pointer", whiteSpace: "nowrap" },
  ...
  noAlert: { fontSize: 14, color: GREEN, background: VERT_FOND, borderRadius: 10, padding: "14px", textAlign: "center", margin: "0 0 8px" },
  ...
  tableInput: { width: "100%", maxWidth: 140, border: "1px solid #DDE2DE", borderRadius: 6, padding: "5px 8px", fontSize: 14, fontFamily: "inherit", color: INK },
