...
const styles = {
  ...
  sous: { fontSize: 14, color: TEXTE_GRIS, margin: "6px 0 0" },
  ...
  tab: { flex: 1, display: "flex", alignItems: "center", justifyContent: "center", gap: 6, background: FOND_PAGE, border: "1px solid #ECE9DF", color: TEXTE_META, padding: "8px 8px", borderRadius: 10, fontSize: 14, fontWeight: 500, fontFamily: "inherit", cursor: "pointer" },
  ...
  submitBtn: { alignSelf: "flex-start", display: "flex", alignItems: "center", gap: 6, background: GREEN, color: "#fff", border: "none", borderRadius: 10, padding: "9px 18px", fontSize: 14, fontWeight: 600, fontFamily: "inherit", cursor: "pointer" },
  ...
  tableInputNum: { width: 70, border: "1px solid #DDE2DE", borderRadius: 6, padding: "5px 8px", fontSize: 14, fontFamily: "inherit", color: INK, textAlign: "right" },
